...
[`@aws-sdk/client-cost-explorer`](https://www.npmjs.com/package/@aws-sdk/client-cost-explorer/v/3.1091.0).
...
- @aws-sdk/client-cost-explorer v3.1091.0 - [https://cloud-sdk-builds.github.io/?sdk=client-cost-explorer&version=3.1091.0](https://cloud-sdk-builds.github.io/?sdk=client-cost-explorer&version=3.1091.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cost-explorer@3.1091.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ATHZMZGh1YCY7+dbnVQ/x0S1xR+nZnMqmHnLHfjVJgvnWHhtA5wLx9kp216x5+Wk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-cost-explorer": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cost-explorer@3.1091.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-cost-explorer@3.1091.0/index.min.mjs": "sha384-ATHZMZGh1YCY7+dbnVQ/x0S1xR+nZnMqmHnLHfjVJgvnWHhtA5wLx9kp216x5+Wk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-cost-explorer/blob/refs/tags/3.1091.0/LICENSE
```
